...
class DollSlot extends PureComponent {
    render() {
        const {filled, images, storage, slotTranslation, usedArtifacts, artifacts} = this.props;
        ...
        return (
            <div class={cn(ROOT, positionClassName)} onClick={this.onRootClick}>
                ...
                {filled && (
                    <Artifact info={filled} images={images} usedArtifacts={usedArtifacts} artifacts={artifacts} />
                )}
            </div>
        );
    }
