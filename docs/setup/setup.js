...
`}return r.join("").replace(/%20/g," ")};te.exports=c;te.exports.diff_match_patch=c;te.exports.DIFF_DELETE=_;te.exports.DIFF_INSERT=w;te.exports.DIFF_EQUAL=d});function ut(e,...t){let r=[],{length:i}=e;for(let n=0;n<i;n++)r.push(e[n],t[n]);r.pop();let a=r.join("");return a=a.replaceAll(/\/\*[\s\S]*?\*\//g,""),a=a.replaceAll(/\s\/\/.*/g,""),a}var j=ut;var B="gameDirHandle",ne="mirrorDirHandle",M="log-host",oe="is-disabled",P="status-ok",N="status-warning",H="status-progress",W="btn-game",le="btn-mirror",Z="btn-retrieve",Q="btn-preview",X="btn-save",L="diff-list",G="diff-path",ce="diff-label",ie="diff-new",q="diff-identical",Y="diff-changed",z="diff-content",x="diff-collapsed";var gt=j`
    /* ================== GENERAL ================== */
...
`,$e=Et;var Ce=window.location.host||"localhost",ee="store";async function F(e){if(!(await indexedDB.databases()).find(i=>i.name===Ce))return;let r=await Be();if(!r.objectStoreNames.contains(ee)){r.close();return}return new Promise((i,a)=>{let n=r.transaction(ee).objectStore(ee).get(e);n.onsuccess=()=>{i(n.result),r.close()},n.onerror=()=>{a(n.error),r.close()}})}async function Oe(e,t){let r=await Be();return new Promise((i,a)=>{let n=r.transaction(ee,"readwrite");n.objectStore(ee).put(t,e),n.oncomplete=()=>{i(),r.close()},n.onerror=()=>{a(n.error),r.close()}})}function Be(){return new Promise((e,t)=>{let r=indexedDB.open(Ce);r.onupgradeneeded=i=>i.target.result.createObjectStore(ee),r.onsuccess=()=>e(r.result),r.onerror=()=>t(r.error)})}async function yt(e,t,r){return new Promise(i=>{let a=n=>{let s=n.data&&typeof n.data=="object"?n.data:{};s.type===t&&(e.removeEventListener("message",a),i(s.payload))};e.addEventListener("message",a),e.postMessage({type:t,payload:r})})}var me=yt;function At(e,t,r){e.postMessage({type:t,payload:r})}var He=At;async function Tt(e,t,r,i){return Ge(e,"",t,r,i)}async function Ge(e,t,r,i,a){t+=t?"/":"";let n={},s=await Mt(e);for(let[o,l]of s){let f=t+o;if(!(i&&f.match(i))){if(l.kind==="directory"){let h=await Ge(l,f,r,i,a);if(h instanceof File)return h;Object.assign(n,h)}else if(f.match(r)){let h=await l.getFile();if(a)return h;n[f]=h}}}return n}async function Mt(e){let t=[];try{for await(let r of e.entries())t.push(r)}catch{}return t}var Ue=Tt;async function It(e){return await e?.queryPermission()==="granted"}var $=It;function kt(e){return document.querySelector("."+e)}var U=kt;function Rt(e,t,r){let i;typeof t=="string"?(t.match(/^[a-z]/)&&(t="."+t),i=Array.from(document.querySelectorAll(t))):Array.isArray(t)?i=t:i=[t];for(let a of i)a.addEventListener(e,r)}var C=Rt;async function Ft(e){let t=await F(e);if(t&&!await $(t)){if(await t.requestPermission(),await $(t))return t}try{t=await window.showDirectoryPicker({mode:"read"})}catch{}return t&&await Oe(e,t),t}var ae=Ft;var ge=ht(je(),1),Pt=new ge.default;function Lt(e,t){let r=We(e),i=We(t),a=Pt.diff_main(r,i),n=[],s=[];for(let[h,u]of a)switch(h){case ge.default.DIFF_DELETE:n.push("<del>"+u+"</del>"),s.push("<del></del>");break;case ge.default.DIFF_INSERT:n.push("<ins></ins>"),s.push("<ins>"+u+"</ins>");break;default:n.push(u),s.push(u)}let o=n.join("").replaceAll("</del><ins></ins>","</del>"),l=s.join("").replaceAll("<del></del><ins>","<ins>"),f=l.split("<").length-1;return{text1:o,text2:l,differences:f/2}}function We(e){return e.split("&").join("&amp;").split("<").join("&lt;").split(">").join("&gt;")}var Ve=Lt;var Nt={[ie]:"new",[q]:"identical",[Y]:"changed"};function $t(e,t,r){let i=[];for(let a in t){let n=t[a],s=e[a];if(s!==void 0){let{text1:l,text2:f}=Ve(s,n);s=l,n=f}else n=Ot(n);let o=Ct(a,s,n);i.push(...o)}r.innerHTML=i.join(""),C("click","."+G,Bt),Ht(r)}function Ct(e,t,r){let i=t===void 0?ie:t===r?q:Y,a=`<div class="${ce}">${Nt[i]}</div>`,n=i===q?x:"",s=[];return s.push(`<div class="${G} ${i}">${a}${e}</div>`),s.push(`<div class="${z} ${n}">`),i===Y&&s.push(`<pre>${t}</pre>`),s.push(`<pre>${r}</pre>`),s.push("</div>"),s}function Ot(e){return e.split("&").join("&amp;").split("<").join("&lt;").split(">").join("&gt;")}function Bt(e){e.currentTarget.nextElementSibling.classList.toggle(x)}function Ht(e){let t=e.querySelectorAll("."+G);for(let r of t)if(!r.nextElementSibling.classList.contains(x)){r.scrollIntoView({behavior:"smooth",block:"start"});break}}var pe=$t;var Gt=new RegExp("[ :]");function Ut(e){if(e.match(Gt)){S("Path contains an illegal character!",e);return}if(e.match("/.*?/")){S("Path contains too many slashes!",e);return}let t=e;return t=t.replace(/^Main\//,""),t=t.replace("/",":"),t=t.replaceAll("~","/"),t=t.replaceAll("_"," "),t=t.replaceAll("#",":"),t=t.replace(/\.lua$/,""),t=t.replace(/\.wiki$/,""),t}var de=Ut;var jt=new Set(["Main","Data","Media","Special","Talk","User","User talk","Project","Project talk","File","File talk","MediaWiki","MediaWiki talk","Template","Template talk","Help","Help talk","Category","Category talk","Module","Module talk"]),Wt=new Set(["css"]),Vt=new RegExp("~");function zt(e){e.match(Vt)&&S("Title contains an illegal character!",e);let{namespace:t,titleWithoutNamespace:r}=Kt(e),i=r;return i=i.replaceAll("/","~"),i=i.replaceAll(" ","_"),i=i.replaceAll(":","#"),i=Jt(i),i=Zt(i,t),t.replace(" ","_")+"/"+i}function Kt(e){let[,t,r]=e.match(/(.*?):(.*)/)||[null,"",e];return jt.has(t)||(t="",r=e),t=t||"Main",{namespace:t,titleWithoutNamespace:r}}function Jt(e){let t=(e.match(/\.([a-zA-Z]+)$/)||[null,""])[1].toLowerCase();return t==="url"?e.replace(/\.url$/,""):Wt.has(t)?e:e+".wiki"}function Zt(e,t){return t!=="Module"||e.endsWith("~doc.wiki")||e.endsWith(".css")?e:e.replace(".wiki",".lua")}var ze=zt;async function Qt(e){return e.then(t=>[t,null]).catch(t=>[null,t])}var be=Qt;var _e;async function se(e){if(!_e){console.log("Please call applySettings() prior to asking!");return}let t={method:Xt(e)},r=new URL(_e.API_URL),i=qt(e);t.method==="GET"?r.search=i.toString():t.body=i;let[a,n]=await be(fetch(r,t));if(!a){S("Failed to fetch!",n);return}let[s,o]=await be(a.json());if(!s){S("Invalid json!",o);return}return s}function Ke(e){let{API_URL:t}=e;_e={API_URL:t}}function Xt(e){return!e.method||e.method==="GET"?"GET":"POST"}function qt(e){let t={...e,format:"json",formatversion:2},{method:r}=t;if(delete t.method,r==="FORM"){let i=new FormData;for(let a in t){let n=t[a];Array.isArray(n)?i.append(a,n[0],n[1]):i.append(a,n)}return i}return new URLSearchParams(t)}var Je=50;async function Yt(e){let t=Object.keys(e).map(a=>de(a)),r=await xt(t);if(!r)return;let i={};for(let a in r){let n=ze(a);n&&(r[a]===void 0?S("Invalid page content!",a):i[n]=r[a])}return S(`Retrieved ${Object.keys(i).length} pages.`),i}async function xt(e){let t={};for(let r=0;r<e.length;r+=Je){let i=Math.min(r+Je,e.length),a=e.slice(r,i);S(`Retrieving ${r+1}-${i} of ${e.length} pages (${a[0]})...`);let n=await se({action:"query",prop:"revisions",rvprop:"content",rvslots:"main",titles:a.join("|"),origin:"*"});if(!n)continue;let s=n.query?.pages||[];for(let o of s)o.missing||(t[o.title]=o.revisions?.[0]?.slots?.main?.content)}return t}var Ze=Yt;function er(e,t){e.classList.toggle(P,t===P),e.classList.toggle(N,t===N),e.classList.toggle(H,t===H)}var V=er;async function tr(e,t){let r=rr(e,t);if(!r.length)return S("All pages are already updated."),!0;let i=await nr();if(!i)return S("Cannot get csrf token!"),!1;let a=0;for(let{title:n,content:s}of r)await ir(n,s,i)&&a++;return S(`Successfully saved ${a} pages.`),!0}async function rr(e,t){let r=[];t=t||{};for(let i in e){let a=e[i],n=t[i];if(a!==n){let s=de(i);r.push({title:s,content:a})}}return r}async function nr(){return(await se({action:"query",meta:"tokens"}))?.query?.tokens?.csrftoken}async function ir(e,t,r){return S(`Saving content for "${e}"...`),(await se({method:"POST",action:"edit",title:e,text:t,token:r}))?.edit?.result!=="Success"?(S("Save failed!",e,t),!1):!0}var Qe=tr;function ar(){return document.location.href.replace(/[^\/]*$/,"")+"api.php"}var Xe=ar;var qe,Ye,we,Se,De,Ee,K={parserResult:null,mirrorResult:null,progressingButton:null,hasDirAccess:!1,hasPreviewed:!1,hasSaved:!1};async function sr(e,t){qe=e,Ye=t,we=U(W),Se=U(Z),De=U(Q),Ee=U(X),C("click",we,lr),C("click",Se,cr),C("click",De,fr),C("click",Ee,hr);let r=await F(B);J({hasDirAccess:await $(r)}),Ke({API_URL:Xe()})}function J(e){Object.assign(K,e),or()}function or(){let{hasDirAccess:e,progressingButton:t,mirrorResult:r,hasPreviewed:i,hasSaved:a}=K;qe.classList.toggle(oe,!!t),V(we,e?P:N);let n;t===Z?n=H:n=r?P:null,V(Se,n);let s;t===Q?s=H:s=i?P:null,V(De,s);let o;t===X?o=H:o=a?P:null,V(Ee,o)}async function lr(){let e=await F(B);await ae(B);let t=await F(B);await e.isSameEntry(t)||J({parserResult:null,mirrorResult:null,progressingButton:null,hasDirAccess:await $(t),hasPreviewed:!1,hasSaved:!1})}async function cr(){await ye(Z),J({mirrorResult:await Ze(K.parserResult)})}async function fr(){await ye(Q);let e=window.open("","Preview");if(!e)return;let t=e.document;t.open(),t.write(`
    ...
    `),t.close();let{mirrorResult:r,parserResult:i}=K;pe(r||{},i,t.querySelector("."+L)),J({hasPreviewed:!0})}async function hr(){await ye(X);let e=await Qe(K.parserResult,K.mirrorResult);J({hasSaved:e})}async function ye(e){if(!K.parserResult){J({isWorking:!0,progressingButton:e});let t=await Ye();J({parserResult:t,isWorking:!0,progressingButton:null})}}var xe=sr;async function ur(e,t){let r=t.split("/"),i=r.pop(),a=e;for(let s of r)try{a=await a.getDirectoryHandle(s)}catch{return}let n;try{n=await a.getFileHandle(i)}catch{return}try{return await n.getFile()}catch{}}var et=ur;var tt,Ae,Te,Me={hasGameAccess:!1,hasMirrorAccess:!1};async function gr(e,t){tt=t,Ae=U(W),Te=U(le),C("click",Ae,vr),C("click",Te,mr),await Ie()}function pr(e){Object.assign(Me,e),dr()}function dr(){let{hasGameAccess:e,hasMirrorAccess:t}=Me;V(Ae,e?P:N),V(Te,t?P:N)}async function vr(){let e=await F(B),t=await ae(B);await e.isSameEntry(t)||await Ie()}async function mr(){let e=await F(ne),t=await ae(ne);await e.isSameEntry(t)||await Ie()}async function Ie(){let e=await F(B),t=await F(ne);if(pr({hasGameAccess:$(e),hasMirrorAccess:$(t)}),!Me.hasGameAccess)return;let r=await tt(),i=await br(r);pe(i,r,U(L))}async function br(e){let t={},r=await F(ne);if(!await $(r))return t;for(let i in e){let a=await et(r,i);t[i]=a?await a.text():void 0}return t}var rt=gr;var _r="gameDirHandle",re;async function wr(){let e=document.getElementById("setup");if(!e)return;let t=e.dataset.dev==="1",r=e.dataset.parse;e.innerHTML=t?$e:Fe,Le(e.querySelector("."+M)),S("Initialized."),await Sr(r),t?await rt(e,nt):await xe(e,nt)}async function Sr(e){re=new Worker(`data:application/javascript,importScripts('${e}');`),re.addEventListener("error",()=>S("!Parser error!")),await me(re,"ready"),S("Connected to parser."),re.addEventListener("message",Dr)}async function Dr(e){let t=e.data&&typeof e.data=="object"?e.data:{},{type:r,payload:i}=t;switch(r){case"find":{let a=await F(_r),[n,s,o]=i,l=await Ue(a,n,s,o);He(re,"find",l);break}case"log":{S(...i);break}}}async function nt(){S("Started parsing...");let e=await me(re,"run");return S(`Received ${Object.keys(e).length} parsing results.`),e}wr();})();
