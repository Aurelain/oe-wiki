...
<div class='steps'>
    ...
    <div class='step'>
        ...
        <div class='action'>
            <button class='${j}'>Pick directory</button> 
        </div>
    </div>
    <!-- ==== RETRIEVE =================================== -->
    <div class='step'>
        ...
        <div class='action'>
            <button class='${Z}'>Retrieve <progress/></button> 
        </div>
    </div>
    <!-- ==== PREVIEW =================================== -->
    <div class='step'>
        ...
        <div class='action'>
            <button class='${Q}'>Preview <progress/></button> 
        </div>
    </div>
    <!-- ==== SAVE =================================== -->
    <div class='step'>
        ...
        <div class='action'>
            <button class='${X}'>SAVE <progress/></button> 
        </div>
    </div>
</div>
<!-- ==== LOG =================================== -->
